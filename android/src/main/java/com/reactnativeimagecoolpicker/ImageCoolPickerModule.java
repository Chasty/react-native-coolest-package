package com.reactnativeimagecoolpicker;
...
import static com.reactnativeimagecoolpicker.Utils.*;

@ReactModule(name = ImageCoolPickerModule.NAME)
public class ImageCoolPickerModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  static final String NAME = "ImageCoolPicker";
  ...
  public ImageCoolPickerModule(ReactApplicationContext reactContext) {
    super(reactContext);
